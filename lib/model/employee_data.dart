...
List<EmployeeData> employeeDataFromJson(String str) => List<EmployeeData>.from(
    json.decode(str).map((x) => EmployeeData.fromJson(x)));

String employeeDataToJson(List<EmployeeData> data) =>
